...
export default React.memo(() => {
	return (
		<div id="privacy" className={isMobile ? 'mobile' : ''}>
			<h1>Privacy Policy for NurtureNZ</h1>

			<p>
				At NurtureNZ, accessible from https://nurturenz.co.nz, one of
				our main priorities is the privacy of our visitors. This Privacy
				Policy document contains types of information that is collected
				and recorded by NurtureNZ and how we use it.
			</p>
			...
			<p>
				...
				information that they shared and/or collect in NurtureNZ. This
			...
			<p>
				NurtureNZ follows a standard procedure of using log files. These
			...
			<p>
				Like any other website, NurtureNZ uses 'cookies'. These cookies
			...
			<p>
				...
				the advertising partners of NurtureNZ.
			</p>

			<p>
				Third-party ad servers or ad networks uses technologies like
				cookies, JavaScript, or Web Beacons that are used in their
				respective advertisements and links that appear on NurtureNZ,
			...
			<p>
				Note that NurtureNZ has no access to or control over these
			...
			<p>
				NurtureNZ's Privacy Policy does not apply to other advertisers
			...
			<p>
				NurtureNZ does not knowingly collect any Personal Identifiable
